 ...
 * @author perpustakaan
 */
public final class RMKunjunganFisioterapi extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMKunjunganFisioterapi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            "No.Rawat","No.R.M.","Nama Pasien","Umur","JK","Tgl.Lahir","Tanggal ","Kunjungan Ke","Diagnosa","Terapi","Program","NIP","Dokter/Paramedis","Nip Terapis","Nama Terapis"
        }){
        ...
        for (int i = 0; i < 14; i++) {
            ...
            } else if (i == 7) { // "Kunjungan Ke"
                column.setPreferredWidth(150);
            } else if (i == 8) { // "Diagnosa"
                column.setPreferredWidth(150);
            } else if (i == 9) { // "Terapi"
                column.setPreferredWidth(150);
            } else if (i == 10) { // "Program"
                column.setPreferredWidth(150);
            } else if (i == 11) { // "NIP"
                column.setPreferredWidth(150);
            } else if (i == 12) { // "Dokter/Paramedis"
                column.setPreferredWidth(150);
            } else if (i == 13) { // "Nip Terapis"
                column.setPreferredWidth(140);
            } else if (i == 14) { // "Nama Terapis"
                column.setPreferredWidth(140);
            }
        }
        ...
        Program.setDocument(new batasInput((int)100).getKata(Program));
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Kunjungan KFR ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Liberation Sans", 0, 15), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        btnPegawai.setBounds(761, 40, 28, 23);
        ...
        jLabel12.setBounds(0, 120, 125, 23);
        ...
        Diagnosa.setBounds(130, 120, 660, 23);
        ...
        jLabel13.setBounds(0, 150, 125, 23);
        ...
        Terapi.setBounds(130, 150, 660, 23);

        jLabel15.setText("Program :");
        jLabel15.setName("jLabel15"); // NOI18N
        FormInput.add(jLabel15);
        jLabel15.setBounds(0, 180, 114, 23);
        ...
        Program.setBounds(120, 180, 671, 23);

        jLabel25.setText("Terapis :");
        jLabel25.setName("jLabel25"); // NOI18N
        FormInput.add(jLabel25);
        jLabel25.setBounds(390, 70, 90, 23);
        ...
        FormInput.add(cmbImun);
        cmbImun.setBounds(220, 80, 65, 23);

        jLabel26.setText("Kunjungan Ke :");
        jLabel26.setName("jLabel26"); // NOI18N
        FormInput.add(jLabel26);
        jLabel26.setBounds(130, 80, 90, 23);
        ...
        NmPegawai.setBounds(590, 70, 177, 23);
        ...
        BtnSeekPegawai.setBounds(770, 70, 28, 20);
    ...
    } else if (KdPeg.getText().trim().equals("") || NmPegawai.getText().trim().equals("")) {
        Valid.textKosong(KdPeg, "Pegawai");
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(tbObat.getSelectedRow()!= -1){
            if(Sequel.queryu2tf("delete from kunjungan_fisioterapi where no_rawat=?",1,new String[]{
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            Sequel.mengedit("kunjungan_fisioterapi","no_rawat=?","no_rawat=?,tanggal=?,kunjungan_ke=?,diagnosa=?,terapi=?,program=?,kd_dokter=?,nip=?",9,new String[]{
                TNoRw.getText(),Valid.SetTgl(Tanggal.getSelectedItem()+"")+" "+Jam.getSelectedItem()+":"+Menit.getSelectedItem()+":"+Detik.getSelectedItem(),
                cmbImun.getSelectedItem().toString(),Diagnosa.getText(),Terapi.getText(),Program.getText(),KdDokter.getText(),KdPeg.getText(),
                tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()
            });
    ...
    if(tabMode.getRowCount() == 0) {
        ...
        finger2=Sequel.cariIsi("select sha1(sidikjari.sidikjari) from sidikjari inner join pegawai on pegawai.id=sidikjari.id where pegawai.nik=?", KdPeg.getText());
        finger = Sequel.cariIsi("select sha1(sidikjari.sidikjari) from sidikjari inner join pegawai on pegawai.id=sidikjari.id where pegawai.nik=?", KdDokter.getText());
        param.put("finger2", "Dikeluarkan di " + akses.getnamars() + ", Kabupaten/Kota " + akses.getkabupatenrs() + "\nDitandatangani secara elektronik oleh " + NmPegawai.getText() + "\nID " + (finger.equals("") ? KdPeg.getText() : finger) + "\n" + Tanggal.getSelectedItem());// Tambahkan parameter gambar langsung tanpa variabel baru
        param.put("image_url", "http://" + koneksiDB.HOSTHYBRIDWEB() + ":" + koneksiDB.PORTWEB() + "/" + koneksiDB.HYBRIDWEB() + "/berkasrawat/temp/" + tabMode.getValueAt(tbObat.getSelectedRow(), 1) + ".png");

        if(TCari.getText().trim().equals("")) {
            Valid.MyReportqry("rptCetakKunjunganFisioterapi.jasper", "report", "::[ Kunjungan KFR ]::",
                "select reg_periksa.no_rawat, pasien.no_rkm_medis, pasien.nm_pasien, reg_periksa.umurdaftar, reg_periksa.sttsumur," +
                "pasien.jk, kunjungan_fisioterapi.tanggal, kunjungan_fisioterapi.kunjungan_ke, kunjungan_fisioterapi.diagnosa, kunjungan_fisioterapi.terapi," +
                "kunjungan_fisioterapi.program, kunjungan_fisioterapi.kd_dokter, dokter.nm_dokter, kunjungan_fisioterapi.nip, pegawai.nama, date_format(pasien.tgl_lahir, '%d-%m-%Y') as lahir " +
                "from kunjungan_fisioterapi inner join reg_periksa on kunjungan_fisioterapi.no_rawat=reg_periksa.no_rawat " +
                "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis " +
                "INNER JOIN dokter ON kunjungan_fisioterapi.kd_dokter = dokter.kd_dokter " +
                "inner join pegawai on kunjungan_fisioterapi.nip=pegawai.nik where " +
                "kunjungan_fisioterapi.tanggal between '" + Valid.SetTgl(DTPCari1.getSelectedItem() + "") + " 00:00:00' and '" + Valid.SetTgl(DTPCari2.getSelectedItem() + "") + " 23:59:59' order by kunjungan_fisioterapi.tanggal ", param);
        } else {
            Valid.MyReportqry("rptCetakKunjunganFisioterapi.jasper", "report", "::[ Kunjungan KFR ]::",
                 "select reg_periksa.no_rawat, pasien.no_rkm_medis, pasien.nm_pasien, reg_periksa.umurdaftar, reg_periksa.sttsumur," +
                "pasien.jk, kunjungan_fisioterapi.tanggal, kunjungan_fisioterapi.kunjungan_ke, kunjungan_fisioterapi.diagnosa, kunjungan_fisioterapi.terapi," +
                ...
                "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis " +
                "INNER JOIN dokter ON kunjungan_fisioterapi.kd_dokter = dokter.kd_dokter " +
                "inner join pegawai on kunjungan_fisioterapi.nip=pegawai.nik " +
                "where kunjungan_fisioterapi.tanggal between '" + Valid.SetTgl(DTPCari1.getSelectedItem() + "") + " 00:00:00' and '" + Valid.SetTgl(DTPCari2.getSelectedItem() + "") + " 23:59:59' and " +
                ...
                "kunjungan_fisioterapi.nip like '%" + TCari.getText().trim() + "%' or pegawai.nama like '%" + TCari.getText().trim() + "%') order by kunjungan_fisioterapi.tanggal ", param);
        }
    }
    ...
    private void DetikKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_DetikKeyPressed
        Valid.pindah(evt,Menit,btnPegawai);
    }//GEN-LAST:event_DetikKeyPressed

    private void KdPegKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KdPegKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_PAGE_DOWN){
            Sequel.cariIsi("select nama from pegawai where nik=?",NmDokter,KdPeg.getText());
        }else if(evt.getKeyCode()==KeyEvent.VK_PAGE_UP){
            Detik.requestFocus();
    ...
    private void DiagnosaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_DiagnosaKeyPressed
        Valid.pindah(evt,btnPegawai,Terapi);
    ...
    private void TerapiKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TerapiKeyPressed
        Valid.pindah(evt,Diagnosa,Program);
    ...
    private void ProgramKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_ProgramKeyPressed
        Valid.pindah(evt,Terapi,Diagnosa);
...
//        Valid.pindah(evt,Jabatan,Terapi);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMKunjunganFisioterapi dialog = new RMKunjunganFisioterapi(new javax.swing.JFrame(), true);
        ...
        try {
            if (TCari.getText().toString().trim().equals("")) {
                ps = koneksi.prepareStatement(
                        "SELECT reg_periksa.no_rawat, pasien.no_rkm_medis, pasien.nm_pasien, reg_periksa.umurdaftar, reg_periksa.sttsumur, "
                        + "pasien.jk, kunjungan_fisioterapi.tanggal, kunjungan_fisioterapi.kunjungan_ke, kunjungan_fisioterapi.diagnosa, kunjungan_fisioterapi.terapi, "
                        + "kunjungan_fisioterapi.program, kunjungan_fisioterapi.kd_dokter, dokter.nm_dokter, kunjungan_fisioterapi.nip, pegawai.nama, "
                        + "DATE_FORMAT(pasien.tgl_lahir, '%d-%m-%Y') AS lahir "
                        + "FROM kunjungan_fisioterapi "
                        + "INNER JOIN reg_periksa ON kunjungan_fisioterapi.no_rawat = reg_periksa.no_rawat "
                        + "INNER JOIN pasien ON reg_periksa.no_rkm_medis = pasien.no_rkm_medis "
                        + "INNER JOIN dokter ON kunjungan_fisioterapi.kd_dokter = dokter.kd_dokter "
                        + // JOIN dokter
                        "INNER JOIN pegawai ON kunjungan_fisioterapi.nip = pegawai.nik where "+
                        "kunjungan_fisioterapi.tanggal between ? and ? order by kunjungan_fisioterapi.tanggal ");
            } else {
                ps = koneksi.prepareStatement(
                        "SELECT reg_periksa.no_rawat, pasien.no_rkm_medis, pasien.nm_pasien, reg_periksa.umurdaftar, reg_periksa.sttsumur, "
                        + "pasien.jk, kunjungan_fisioterapi.tanggal, kunjungan_fisioterapi.kunjungan_ke, kunjungan_fisioterapi.diagnosa, kunjungan_fisioterapi.terapi, "
                        ...
                        "INNER JOIN pegawai ON kunjungan_fisioterapi.nip = pegawai.nik "
                        + // JOIN pegawai
                        "where kunjungan_fisioterapi.tanggal between ? and ? and "+
                        "(reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or kunjungan_fisioterapi.nip like ?) "+
                        "order by kunjungan_fisioterapi.tanggal ");
            }
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("lahir"), rs.getString("tanggal"), rs.getString("kunjungan_ke"),
                        rs.getString("diagnosa"), rs.getString("terapi"), rs.getString("program"),
                        rs.getString("kd_dokter"), rs.getString("nm_dokter"), rs.getString("nip"), rs.getString("nama")
                    });
                }
            } catch (Exception e) {
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            KdPeg.setText(tbObat.getValueAt(tbObat.getSelectedRow(),13).toString());
            NmPegawai.setText(tbObat.getValueAt(tbObat.getSelectedRow(),14).toString());
    ...
    public void setNoRm(String norwt, Date tgl2) {
       ...
       TCari.setText(norwt);
       //TCari.setText(TNoRM.getText());
       //Sequel.cariIsi("select reg_periksa.tgl_registrasi from reg_periksa where reg_periksa.no_rkm_medis='"+TNORM+"'", DTPCari1);
    ...
    public void isCek(){
        ...
        if(akses.getjml2()>=1){
            ...
            Sequel.cariIsi("select pegawai.nama from pegawai where pegawai.nik=?",NmDokter,KdPeg.getText());
//            Sequel.cariIsi("select pegawai.jbtn from pegawai where pegawai.nik=?",Jabatan,KdPeg2.getText());
