...
public final class RMFormulirFisioterapi extends javax.swing.JDialog {
    ...
    public RMFormulirFisioterapi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "Pemeriksaan Fisik","Diagnosa Medis","Diagnosa Fungsi","Pemeriksaan Penunjang","Tata Laksana KFR","Anjuran","Evaluasi","Evaluasi Suspek",
            "Ket Evaluasi Suspek","Permintaan Terapi","Goal Of Treatment","Kode Dokter","Nama Dokter"
        }){
        ...
        PermintaanTerapi.setDocument(new batasInput((int)200).getKata(PermintaanTerapi));
        GoalOfTreatment.setDocument(new batasInput((int)200).getKata(GoalOfTreatment));
    ...
    private void initComponents() {
        ...
        GoalOfTreatment = new widget.TextArea();
        ...
        PermintaanTerapi2 = new widget.TextArea();
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Formulir Fisioterapi ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Liberation Sans", 0, 15), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "04-12-2024 06:07:41" }));
        ...
        jSeparator1.setBounds(0, 129, 880, 3);
        ...
        jLabel55.setText("Suspek Penyakit AKibat Kerja");
        jLabel55.setName("jLabel55"); // NOI18N
        FormInput.add(jLabel55);
        jLabel55.setBounds(80, 980, 200, 23);
        ...
        EvaluasiSuspek.setBounds(280, 980, 90, 23);
        ...
        KetEvaluasiSuspek.setBounds(380, 980, 215, 23);
        ...
        Evaluasi.setPreferredSize(new java.awt.Dimension(102, 52));
        ...
        scrollPane16.setBounds(80, 870, 780, 63);

        jLabel104.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel104.setText("Goal Of Treatment :");
        jLabel104.setName("jLabel104"); // NOI18N
        FormInput.add(jLabel104);
        jLabel104.setBounds(80, 1110, 330, 23);

        jLabel105.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel105.setText("Anjuran");
        jLabel105.setName("jLabel105"); // NOI18N
        FormInput.add(jLabel105);
        jLabel105.setBounds(80, 740, 330, 23);

        jLabel106.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel106.setText("Anjuran");
        jLabel106.setName("jLabel106"); // NOI18N
        FormInput.add(jLabel106);
        jLabel106.setBounds(80, 740, 330, 23);

        scrollPane17.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        scrollPane17.setName("scrollPane17"); // NOI18N

        GoalOfTreatment.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        GoalOfTreatment.setColumns(20);
        GoalOfTreatment.setRows(5);
        GoalOfTreatment.setName("GoalOfTreatment"); // NOI18N
        GoalOfTreatment.setPreferredSize(new java.awt.Dimension(102, 52));
        GoalOfTreatment.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                GoalOfTreatmentKeyPressed(evt);
            }
        });
        scrollPane17.setViewportView(GoalOfTreatment);

        FormInput.add(scrollPane17);
        scrollPane17.setBounds(80, 1130, 780, 63);

        jLabel107.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel107.setText("Evaluasi");
        jLabel107.setName("jLabel107"); // NOI18N
        FormInput.add(jLabel107);
        jLabel107.setBounds(80, 840, 330, 23);
        ...
        scrollPane18.setBounds(80, 770, 770, 63);
        ...
        PermintaanTerapi.setPreferredSize(new java.awt.Dimension(102, 52));
        PermintaanTerapi.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                PermintaanTerapiKeyPressed(evt);
            }
        });
        scrollPane19.setViewportView(PermintaanTerapi);

        FormInput.add(scrollPane19);
        scrollPane19.setBounds(80, 1040, 780, 63);

        jLabel108.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel108.setText("Permintaan Terapi :");
        jLabel108.setName("jLabel108"); // NOI18N
        FormInput.add(jLabel108);
        jLabel108.setBounds(80, 1010, 330, 23);
        ...
        PermintaanTerapi2.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        PermintaanTerapi2.setColumns(20);
        PermintaanTerapi2.setRows(5);
        PermintaanTerapi2.setName("PermintaanTerapi2"); // NOI18N
        PermintaanTerapi2.setPreferredSize(new java.awt.Dimension(102, 52));
        PermintaanTerapi2.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                PermintaanTerapi2KeyPressed(evt);
            }
        });
        scrollPane20.setViewportView(PermintaanTerapi2);

        FormInput.add(scrollPane20);
        scrollPane20.setBounds(80, 1040, 780, 63);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")){
           ...
           if(Sequel.menyimpantf("formulir_fisioterapi","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",16,new String[]{
                    ...
                    Anjuran.getText(),Evaluasi.getText(),EvaluasiSuspek.getSelectedItem().toString(),KetEvaluasiSuspek.getText(),PermintaanTerapi.getText(),GoalOfTreatment.getText(),
                    KdDokter.getText()
                })==true){
                    emptTeks();
            }
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        ...
        }else if(GoalOfTreatment.getText().trim().equals("")){
            Valid.textKosong(GoalOfTreatment,"Goal Of Treatment");
        }
        else if(KdDokter.getText().trim().equals("")||NmDokter.getText().trim().equals("")){
            Valid.textKosong(KdDokter,"Dokter");
        }else{
            ...
            try{
                if(TCari.getText().equals("")){
                    ps=koneksi.prepareStatement(
                            ...
                            "formulir_fisioterapi.evaluasi,formulir_fisioterapi.evaluasi_suspek,formulir_fisioterapi.ket_evaluasi_suspek,formulir_fisioterapi.permintaan_terapi,formulir_fisioterapi.goal_of_treatment,formulir_fisioterapi.kd_dokter,dokter.nm_dokter "+
                ...
                try {
                    ...
                    htmlContent.append(                             
                        "<tr class='isi'>"+
                            ...
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='70px'><b>evaluasi</b></td>"+
                            ...
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='130px'><b>permintaan_terapi</b></td>"+
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='130px'><b>goal_of_treatment</b></td>"+
                    ...
                    while(rs.next()){
                        htmlContent.append(
                            "<tr class='isi'>"+
                               ...
                               "<td valign='top'>"+rs.getString("evaluasi")+"</td>"+
                               "<td valign='top'>"+rs.getString("evaluasi_suspek")+"</td>"+
                               "<td valign='top'>"+rs.getString("ket_evaluasi_suspek")+"</td>"+
                               "<td valign='top'>"+rs.getString("permintaan_terapi")+"</td>"+
                               "<td valign='top'>"+rs.getString("goal_of_treatment")+"</td>"+
    ...
    private void DiagnosaMedisKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_DiagnosaMedisKeyPressed
        Valid.pindah2(evt,DiagnosaMedis,Evaluasi);
    ...
    private void GoalOfTreatmentKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_GoalOfTreatmentKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_GoalOfTreatmentKeyPressed
    ...
    private void PermintaanTerapi2KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_PermintaanTerapi2KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_PermintaanTerapi2KeyPressed
    ...
    */
    ...
    private widget.TextArea GoalOfTreatment;
    ...
    private widget.TextArea PermintaanTerapi2;
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("pemeriksaan_penunjang"),rs.getString("tata_laksana_kfr"),rs.getString("anjuran"),rs.getString("evaluasi"),rs.getString("evaluasi_suspek"),
                        rs.getString("ket_evaluasi_suspek"),rs.getString("permintaan_terapi"),rs.getString("goal_of_treatment"),rs.getString("kd_dokter"),rs.getString("nm_dokter")
                    });
                }
            } catch (Exception e) {
                System.out.println("Notif : "+e);
    ...
    private void getData() {
        ...
        if(tbObat.getSelectedRow()!= -1){
            ...
            EvaluasiSuspek.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),17).toString()); 
            KetEvaluasiSuspek.setText(tbObat.getValueAt(tbObat.getSelectedRow(),18).toString());
            PermintaanTerapi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),19).toString()); 
            GoalOfTreatment.setText(tbObat.getValueAt(tbObat.getSelectedRow(),20).toString()); 
            KdDokter.setText(tbObat.getValueAt(tbObat.getSelectedRow(),21).toString()); 
            NmDokter.setText(tbObat.getValueAt(tbObat.getSelectedRow(),22).toString()); 
    ...
    private void ganti() {
        // "No.Rawat","No.RM","Nama Pasien","J.K.","Tgl.Lahir","Tanggal","Informasi","Alamat","No. Tlp","Amnesa", 
           // "Pemeriksaan Fisik","Diagnosa Medis","Diagnosa Fungsi","Pemeriksaan Penunjang","Tata Laksana KFR","Anjuran","Evaluasi","Evaluasi Suspek",
           // "Ket Evaluasi Suspek","Permintaan Terapi","Goal Of Treatment","Kode Dokter","Nama Dokter"
        if(Sequel.mengedittf("formulir_fisioterapi","no_rawat=?","no_rawat=?,tanggal=?,informasi=?,amnesa=?,pemeriksaan_fisik=?,diagnosa_medis=?,diagnosa_fungsi=?,pemeriksaan_penunjang=?,tata_laksana_kfr=?,anjuran=?,evaluasi=?,evaluasi_suspek=?,ket_evaluasi_suspek=?,permintaan_terapi=?,goal_of_treatment=?,kd_dokter=?",17,new String[]{
                TNoRw.getText(),Valid.SetTgl(TglAsuhan.getSelectedItem()+"")+" "+TglAsuhan.getSelectedItem().toString().substring(11,19),Informasi.getSelectedItem().toString(),Amnesa.getText(),
                PemeriksaanFisik.getText(),DiagnosaMedis.getText(),DiagnosaFungsi.getText(),PemeriksaanPenunjang.getText(),TataLaksana.getText(),Anjuran.getText(),Evaluasi.getText(),EvaluasiSuspek.getSelectedItem().toString(),KetEvaluasiSuspek.getText(),
                PermintaanTerapi.getText(),GoalOfTreatment.getText(),KdDokter.getText(),tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()
             })==true){
                tampil();
                emptTeks();
                TabRawat.setSelectedIndex(1);
